...
class PublishCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'yanselmask:publish:bookings {--f|force : Overwrite any existing files.} {--r|resource=* : Specify which resources to publish.}';
     ...
     * @var string
     */
    protected $description = 'Publish Yanselmask Bookings Resources.';
